...
<div class="left">
    <div class="small"><h1>Admin</h1></div>
    <div class="nav">
        <a class="leftside" href="manage_teachers.php">Teachers</a>
        <a class="leftside" href="manage_students.php">Students</a>
        <a class="leftside" href="manage_subjects.php">Subjects</a>
        <a class="leftside" href="manage_classes.php">Classes</a>
        <a class="leftside" href="verify_accounts.php">Verify Accounts</a>
        <a class="leftside" href="view_Attendance.php">Attendance Reports</a>
        <a  class ="leftside"href="logout.php" class="logout">Logout</a>
    </div>
</div>
