...
<div class="sidebar">
    ...
    <div class="nav-menu">
        <a class="nav-item" href="manage_teachers.php">Teachers</a>
        <a class="nav-item" href="manage_students.php">Students</a>
        <a class="nav-item" href="manage_subjects.php">Subjects</a>
        <a class="nav-item" href="manage_classes.php">Classes</a>
        <a class="nav-item" href="verify_accounts.php">Verify Accounts</a>
        <a class="nav-item" href="view_Attendance.php">Attendance Reports</a>
    </div>
</div>
